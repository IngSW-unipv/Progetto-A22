...
/**
 * Classe con utilit� per il database
 * @author TawaHabib
 * @version 1.0
 */
public class DataBase {
	...
	/**
	 * Proprit� nel file di configurazione per indicare e � la prima volta.
	 */
	...
	/**
	 * Chiave della proprit� nel file di configurazione che ha la URL.
	 */
	private static final String FIRST_CONFIGURATION_URL_PROPERTIE ="url";
	
	/**
	 * Chiave della proprit� nel file di configurazione che ha la username con il quale connettersi.
	 */
	private static final String FIRST_CONFIGURATION_USERNAME_PROPERTIE ="username";
	
	/**
	 * Chiave della proprit� della password nel file di configurazione che ha la username con il quale connettersi
	 */
	 ...
	 * il db utilizzato; di lascia la responsabilit� a chu usa questo metodo </br>
	...
	/**
	 * Metodo per creare un database secondo le propriet� presenti nel file 
	 ...
	 * <br>falso se il data base non � stato creato
	 */
