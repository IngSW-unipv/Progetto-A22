package it.unipv.ingInf.ingSW.deltaTech4Java.serverDominator.persistence.userAccount;
...
public interface IUserAccountDAO {
	 ...
	 * lo username non deve ambiare. se username non esiste o se password non � quella nel db 
	...
	/**
	 * Agguirna lo username, se nuova username gi� usata da un'altro giocatore fallicse
	 * @param us
	 * @param newUsername
	 * @return
	 */
